// Import the form, reusable food card, styles, and page header used by the app.
import FoodOrderForm from './FoodOrderForm';
import FoodItem from "./FoodItem";
import styles from "./App.module.css";
import Header from './Header.jsx';

// Build the main page layout with the header, menu items, and order form.
function App() {
  return (
    <div className={styles.container}>
      ...
      {/* Sample menu items rendered with the reusable FoodItem component. */}
      ...
      {/* Form section where the user can place a food order. */}
      <FoodOrderForm />
    </div>
  )
}

// Export the main app component for rendering elsewhere.
export default App
